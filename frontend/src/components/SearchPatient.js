...
export default function SearchPatient() {
   ...
   const styles = {
      container: "",
      containerFocus: "",
      input: "w-full border border-gray-300 py-2 px-4 rounded-md text-lg",
      inputFocus: "w-full border border-gray-300 border-b-0 outline-none py-2 px-4 rounded-t-md  text-lg",
      query: "",
      typeahead: "",
      cancelButton: "",
      clearButton: "absolute inset-y-0 right-0 w-8 inline-flex items-center justify-center",
      listbox: "bg-white w-full border border-t-0 border-gray-300 shadow rounded-b-md pt-2 pb-3",
